...
[![CI](https://img.shields.io/github/actions/workflow/status/randytarampi/pseudolocalize/ci.yml?branch=main&style=flat-square&label=CI)](https://github.com/randytarampi/pseudolocalize/actions/workflows/ci.yml) [![CodeQL](https://img.shields.io/github/actions/workflow/status/randytarampi/pseudolocalize/codeql.yml?branch=main&style=flat-square&label=CodeQL)](https://github.com/randytarampi/pseudolocalize/security/code-scanning) [![Qlty Maintainability](https://qlty.sh/gh/randytarampi/projects/pseudolocalize/maintainability.svg?style=flat-square)](https://qlty.sh/gh/randytarampi/pseudolocalize)
